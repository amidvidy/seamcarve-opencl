...
namespace kernel {
    ...
    static cl::Kernel blurKernel;
    static cl::Kernel gradientKernel;
    static cl::Kernel maskUnreachableKernel;
    static cl::Kernel backtrackKernel;
    static cl::Kernel findMinSeamVertKernel;
    static cl::Kernel carveVertKernel;
    static cl::Kernel computeSeamKernel;
    static cl::Kernel DP_trapezoidKernel;
